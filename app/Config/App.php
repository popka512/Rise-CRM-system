...
//rise-saas:start:901d7363aa6703cc2b4da16f00978672428df51b
//dont remove/change above line

            $requestURI = $_SERVER["REQUEST_URI"]; $tenantSig = "/rs";
            $this->indexPage = "";
            $this->baseURL = stripos($requestURI, $tenantSig) === false ? $this->baseURL : $this->baseURL . substr($requestURI, 1, stripos($requestURI, "$tenantSig") + strlen("$tenantSig"));
            
//dont remove/change below line
//rise-saas:end:901d7363aa6703cc2b4da16f00978672428df51b
$this->set_cookie_domain();
     ...
     * @var string
     */
    public $defaultLocale = 'english'; //english
    ...
    /* User configs */
    public $encryption_key = "6e1c8b89a38e933";

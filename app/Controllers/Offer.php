...
class Offer extends Security_Controller {
    ...
    function __construct() {
        parent::__construct();
        $this->init_permission_checker("offer");
    }

    function index() {
        app_redirect("forbidden");
    }
    function preview_verification($proposal_id = 0, $public_key = "") {
        ...
        return view("proposals/proposal_public_preview_verification", $view_data);
    }
